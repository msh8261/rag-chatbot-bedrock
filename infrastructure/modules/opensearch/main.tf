...
# OpenSearch Domain - Commented out (requires AWS subscription)
...
#       availability_zone_count = var.instance_count > 1 ? 2 : 2
#     }
#   }
# 
#   vpc_options {
...
# OpenSearch Domain Policy - Commented out (requires OpenSearch domain)
